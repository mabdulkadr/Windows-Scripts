...
**Get-BatteryHealth** is a PowerShell CLI tool in the **Reporting-Inventory** category of the **Windows-Scripts** enterprise toolkit. Queries Win32_Battery to report DesignCapacity vs FullChargeCapacity, health %, and estimated runtime. Skips desktops without battery.

**Category:** `Reporting-Inventory`
**Script:** `Get-BatteryHealth.ps1`
**Path:** `Reporting-Inventory\Get-BatteryHealth\Get-BatteryHealth.ps1`
...
```powershell
Get-Help .\Get-BatteryHealth.ps1 -Full
Get-Help .\Get-BatteryHealth.ps1 -Examples
```

### Dry Run

```powershell
.\Get-BatteryHealth.ps1 -WhatIf
```
...
|-----------|------|----------|---------|-------------|
| — | — | — | — | Run `Get-Help .\Get-BatteryHealth.ps1 -Full` for parameter documentation |
