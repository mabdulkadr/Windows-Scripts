...
**Get-BrowserExtensionInventory** is a PowerShell CLI tool in the **Reporting-Inventory** category of the **Windows-Scripts** enterprise toolkit. Scans current user Edge and Chrome profile Preferences JSON for installed extensions, reports ID, name, version, and enabled state.

**Category:** `Reporting-Inventory`
**Script:** `Get-BrowserExtensionInventory.ps1`
**Path:** `Reporting-Inventory\Get-BrowserExtensionInventory\Get-BrowserExtensionInventory.ps1`
...
```powershell
Get-Help .\Get-BrowserExtensionInventory.ps1 -Full
Get-Help .\Get-BrowserExtensionInventory.ps1 -Examples
```

### Dry Run

```powershell
.\Get-BrowserExtensionInventory.ps1 -WhatIf
```
...
|-----------|------|----------|---------|-------------|
| — | — | — | — | Run `Get-Help .\Get-BrowserExtensionInventory.ps1 -Full` for parameter documentation |
