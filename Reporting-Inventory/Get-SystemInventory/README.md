...
**Get-SystemInventory** is a PowerShell CLI tool in the **Reporting-Inventory** category of the **Windows-Scripts** enterprise toolkit. CIM-gathers hostname, manufacturer, CPU, RAM, OS into Reports/SystemInventory_<ts>.csv.

**Category:** `Reporting-Inventory`
**Script:** `Get-SystemInventory.ps1`
**Path:** `Reporting-Inventory\Get-SystemInventory\Get-SystemInventory.ps1`
...
```powershell
Get-Help .\Get-SystemInventory.ps1 -Full
Get-Help .\Get-SystemInventory.ps1 -Examples
```

### Dry Run

```powershell
.\Get-SystemInventory.ps1 -WhatIf
```
...
|-----------|------|----------|---------|-------------|
| — | — | — | — | Run `Get-Help .\Get-SystemInventory.ps1 -Full` for parameter documentation |
