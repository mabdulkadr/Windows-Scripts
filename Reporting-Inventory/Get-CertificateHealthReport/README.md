...
**Get-CertificateHealthReport** is a PowerShell CLI tool in the **Reporting-Inventory** category of the **Windows-Scripts** enterprise toolkit. Scans LocalMachine stores and writes certificates expiring within 60 days to Reports/CertHealth_<ts>.csv.

**Category:** `Reporting-Inventory`
**Script:** `Get-CertificateHealthReport.ps1`
**Path:** `Reporting-Inventory\Get-CertificateHealthReport\Get-CertificateHealthReport.ps1`
...
```powershell
Get-Help .\Get-CertificateHealthReport.ps1 -Full
Get-Help .\Get-CertificateHealthReport.ps1 -Examples
```

### Dry Run

```powershell
.\Get-CertificateHealthReport.ps1 -WhatIf
```
...
|-----------|------|----------|---------|-------------|
| — | — | — | — | Run `Get-Help .\Get-CertificateHealthReport.ps1 -Full` for parameter documentation |
