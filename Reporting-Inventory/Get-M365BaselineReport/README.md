...
**Get-M365BaselineReport** is a PowerShell CLI tool in the **Reporting-Inventory** category of the **Windows-Scripts** enterprise toolkit. Audits local M365-relevant signals (Defender, BitLocker, LAPS, SecureBoot, TLS) and exports Carbon Dark HTML baseline report to Reports.

**Category:** `Reporting-Inventory`
**Script:** `Get-M365BaselineReport.ps1`
**Path:** `Reporting-Inventory\Get-M365BaselineReport\Get-M365BaselineReport.ps1`
...
```powershell
Get-Help .\Get-M365BaselineReport.ps1 -Full
Get-Help .\Get-M365BaselineReport.ps1 -Examples
```

### Dry Run

```powershell
.\Get-M365BaselineReport.ps1 -WhatIf
```
...
|-----------|------|----------|---------|-------------|
| — | — | — | — | Run `Get-Help .\Get-M365BaselineReport.ps1 -Full` for parameter documentation |
