...
**Get-ComplianceReport** is a PowerShell CLI tool in the **Reporting-Inventory** category of the **Windows-Scripts** enterprise toolkit. Combines hotfix, Defender, and disk info into a single Reports/Compliance_<ts>.html.

**Category:** `Reporting-Inventory`
**Script:** `Get-ComplianceReport.ps1`
**Path:** `Reporting-Inventory\Get-ComplianceReport\Get-ComplianceReport.ps1`
...
```powershell
Get-Help .\Get-ComplianceReport.ps1 -Full
Get-Help .\Get-ComplianceReport.ps1 -Examples
```

### Dry Run

```powershell
.\Get-ComplianceReport.ps1 -WhatIf
```
...
|-----------|------|----------|---------|-------------|
| — | — | — | — | Run `Get-Help .\Get-ComplianceReport.ps1 -Full` for parameter documentation |
