...
**Get-CertificateSummary** is a PowerShell CLI tool in the **Reporting-Inventory** category of the **Windows-Scripts** enterprise toolkit. Enumerates My/Root/CA and writes Reports/CertificateSummary_<ts>.csv.

**Category:** `Reporting-Inventory`
**Script:** `Get-CertificateSummary.ps1`
**Path:** `Reporting-Inventory\Get-CertificateSummary\Get-CertificateSummary.ps1`
...
```powershell
Get-Help .\Get-CertificateSummary.ps1 -Full
Get-Help .\Get-CertificateSummary.ps1 -Examples
```

### Dry Run

```powershell
.\Get-CertificateSummary.ps1 -WhatIf
```
...
|-----------|------|----------|---------|-------------|
| — | — | — | — | Run `Get-Help .\Get-CertificateSummary.ps1 -Full` for parameter documentation |
