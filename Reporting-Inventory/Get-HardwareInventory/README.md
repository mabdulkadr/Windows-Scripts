...
**Get-HardwareInventory** is a PowerShell CLI tool in the **Reporting-Inventory** category of the **Windows-Scripts** enterprise toolkit. CIM-gathers CPU, memory, OS, and user from each device in the target list and writes one CSV.

**Category:** `Reporting-Inventory`
**Script:** `Get-HardwareInventory.ps1`
**Path:** `Reporting-Inventory\Get-HardwareInventory\Get-HardwareInventory.ps1`
...
```powershell
Get-Help .\Get-HardwareInventory.ps1 -Full
Get-Help .\Get-HardwareInventory.ps1 -Examples
```

### Dry Run

```powershell
.\Get-HardwareInventory.ps1 -WhatIf
```
...
|-----------|------|----------|---------|-------------|
| — | — | — | — | Run `Get-Help .\Get-HardwareInventory.ps1 -Full` for parameter documentation |
