...
**Export-IntuneDashboard** is a PowerShell CLI tool in the **Reporting-Inventory** category of the **Windows-Scripts** enterprise toolkit. Collects local Intune-relevant inventory (OS, BitLocker, Defender, enrollment) and exports a Carbon Dark HTML dashboard to Reports beside script.

**Category:** `Reporting-Inventory`
**Script:** `Export-IntuneDashboard.ps1`
**Path:** `Reporting-Inventory\Export-IntuneDashboard\Export-IntuneDashboard.ps1`
...
```powershell
Get-Help .\Export-IntuneDashboard.ps1 -Full
Get-Help .\Export-IntuneDashboard.ps1 -Examples
```

### Dry Run

```powershell
.\Export-IntuneDashboard.ps1 -WhatIf
```
...
|-----------|------|----------|---------|-------------|
| — | — | — | — | Run `Get-Help .\Export-IntuneDashboard.ps1 -Full` for parameter documentation |
