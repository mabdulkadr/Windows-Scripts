...
**Export-InstalledApplications** is a PowerShell CLI tool in the **Reporting-Inventory** category of the **Windows-Scripts** enterprise toolkit. Reads HKLM Uninstall keys and writes the result to Reports/InstalledApps_<ts>.csv.

**Category:** `Reporting-Inventory`
**Script:** `Export-InstalledApplications.ps1`
**Path:** `Reporting-Inventory\Export-InstalledApplications\Export-InstalledApplications.ps1`
...
```powershell
Get-Help .\Export-InstalledApplications.ps1 -Full
Get-Help .\Export-InstalledApplications.ps1 -Examples
```

### Dry Run

```powershell
.\Export-InstalledApplications.ps1 -WhatIf
```
...
|-----------|------|----------|---------|-------------|
| — | — | — | — | Run `Get-Help .\Export-InstalledApplications.ps1 -Full` for parameter documentation |
