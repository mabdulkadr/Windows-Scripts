...
**Get-StartupTasks** is a PowerShell CLI tool in the **Reporting-Inventory** category of the **Windows-Scripts** enterprise toolkit. Combines Win32_StartupCommand and Scheduled Task data to a Reports/Startup_<ts>.csv.

**Category:** `Reporting-Inventory`
**Script:** `Get-StartupTasks.ps1`
**Path:** `Reporting-Inventory\Get-StartupTasks\Get-StartupTasks.ps1`
...
```powershell
Get-Help .\Get-StartupTasks.ps1 -Full
Get-Help .\Get-StartupTasks.ps1 -Examples
```

### Dry Run

```powershell
.\Get-StartupTasks.ps1 -WhatIf
```
...
|-----------|------|----------|---------|-------------|
| — | — | — | — | Run `Get-Help .\Get-StartupTasks.ps1 -Full` for parameter documentation |
