...
**Get-LocalUsersAndGroups** is a PowerShell CLI tool in the **Reporting-Inventory** category of the **Windows-Scripts** enterprise toolkit. Combines Get-LocalUser and Get-LocalGroupMember into Reports/LocalUsersGroups_<ts>.csv.

**Category:** `Reporting-Inventory`
**Script:** `Get-LocalUsersAndGroups.ps1`
**Path:** `Reporting-Inventory\Get-LocalUsersAndGroups\Get-LocalUsersAndGroups.ps1`
...
```powershell
Get-Help .\Get-LocalUsersAndGroups.ps1 -Full
Get-Help .\Get-LocalUsersAndGroups.ps1 -Examples
```

### Dry Run

```powershell
.\Get-LocalUsersAndGroups.ps1 -WhatIf
```
...
|-----------|------|----------|---------|-------------|
| — | — | — | — | Run `Get-Help .\Get-LocalUsersAndGroups.ps1 -Full` for parameter documentation |
