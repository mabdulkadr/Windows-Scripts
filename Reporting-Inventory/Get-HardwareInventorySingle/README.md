...
**Get-HardwareInventorySingle** is a PowerShell CLI tool in the **Reporting-Inventory** category of the **Windows-Scripts** enterprise toolkit. CIM-gathers hardware info for the supplied device and writes Reports/HardwareInventorySingle_<ts>.csv.

**Category:** `Reporting-Inventory`
**Script:** `Get-HardwareInventorySingle.ps1`
**Path:** `Reporting-Inventory\Get-HardwareInventorySingle\Get-HardwareInventorySingle.ps1`
...
```powershell
Get-Help .\Get-HardwareInventorySingle.ps1 -Full
Get-Help .\Get-HardwareInventorySingle.ps1 -Examples
```

### Dry Run

```powershell
.\Get-HardwareInventorySingle.ps1 -WhatIf
```
...
|-----------|------|----------|---------|-------------|
| — | — | — | — | Run `Get-Help .\Get-HardwareInventorySingle.ps1 -Full` for parameter documentation |
