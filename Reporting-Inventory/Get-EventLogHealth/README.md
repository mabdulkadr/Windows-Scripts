...
**Get-EventLogHealth** is a PowerShell CLI tool in the **Reporting-Inventory** category of the **Windows-Scripts** enterprise toolkit. Counts error/warning events with Get-WinEvent over the last 7 days.

**Category:** `Reporting-Inventory`
**Script:** `Get-EventLogHealth.ps1`
**Path:** `Reporting-Inventory\Get-EventLogHealth\Get-EventLogHealth.ps1`
...
```powershell
Get-Help .\Get-EventLogHealth.ps1 -Full
Get-Help .\Get-EventLogHealth.ps1 -Examples
```

### Dry Run

```powershell
.\Get-EventLogHealth.ps1 -WhatIf
```
...
|-----------|------|----------|---------|-------------|
| — | — | — | — | Run `Get-Help .\Get-EventLogHealth.ps1 -Full` for parameter documentation |
