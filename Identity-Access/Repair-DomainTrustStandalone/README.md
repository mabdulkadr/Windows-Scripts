...
**Repair-DomainTrustStandalone** is a PowerShell CLI tool in the **Identity-Access** category of the **Windows-Scripts** enterprise toolkit. Prompts the operator for a DC name then runs Test-ComputerSecureChannel -Repair.

**Category:** `Identity-Access`
**Script:** `Repair-DomainTrustStandalone.ps1`
**Path:** `Identity-Access\Repair-DomainTrustStandalone\Repair-DomainTrustStandalone.ps1`
...
```powershell
Get-Help .\Repair-DomainTrustStandalone.ps1 -Full
Get-Help .\Repair-DomainTrustStandalone.ps1 -Examples
```

### Dry Run

```powershell
.\Repair-DomainTrustStandalone.ps1 -WhatIf
```
...
|-----------|------|----------|---------|-------------|
| — | — | — | — | Run `Get-Help .\Repair-DomainTrustStandalone.ps1 -Full` for parameter documentation |
