...
**Disable-InactiveComputers** is a PowerShell CLI tool in the **Identity-Access** category of the **Windows-Scripts** enterprise toolkit. Filters AD computers by LastLogonDate and disables stale accounts.

**Category:** `Identity-Access`
**Script:** `Disable-InactiveComputers.ps1`
**Path:** `Identity-Access\Disable-InactiveComputers\Disable-InactiveComputers.ps1`
...
```powershell
Get-Help .\Disable-InactiveComputers.ps1 -Full
Get-Help .\Disable-InactiveComputers.ps1 -Examples
```

### Dry Run

```powershell
.\Disable-InactiveComputers.ps1 -WhatIf
```
...
|-----------|------|----------|---------|-------------|
| — | — | — | — | Run `Get-Help .\Disable-InactiveComputers.ps1 -Full` for parameter documentation |
...
* **Permissions:** Account Operator / Domain Admin
