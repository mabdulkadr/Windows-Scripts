...
**New-LocalUserBulk** is a PowerShell CLI tool in the **Identity-Access** category of the **Windows-Scripts** enterprise toolkit. Creates local users from a CSV (Name,Password,Description) with secure handling. Supports -WhatIf preview, skips existing users.

**Category:** `Identity-Access`
**Script:** `New-LocalUserBulk.ps1`
**Path:** `Identity-Access\New-LocalUserBulk\New-LocalUserBulk.ps1`
...
```powershell
Get-Help .\New-LocalUserBulk.ps1 -Full
Get-Help .\New-LocalUserBulk.ps1 -Examples
```

### Dry Run

```powershell
.\New-LocalUserBulk.ps1 -WhatIf
```
...
|-----------|------|----------|---------|-------------|
| — | — | — | — | Run `Get-Help .\New-LocalUserBulk.ps1 -Full` for parameter documentation |
