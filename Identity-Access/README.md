...
# 📂 Identity-Access
**Identity & Access — AD, domain join/trust & device identity — 9 tools**
...
**Identity-Access** contains **9 PowerShell CLI tools** for identity & access — ad, domain join/trust & device identity.
...
* **8 Isolated Tools** — each in `Identity-Access/ScriptName/` with `README.md`
...
| Get-ADDeviceDetails | Get-ADDeviceDetails.ps1 | [Get-ADDeviceDetails](./Get-ADDeviceDetails/) |
| Get-ADUserDetails | Get-ADUserDetails.ps1 | [Get-ADUserDetails](./Get-ADUserDetails/) |
| Get-DomainStatus | Get-DomainStatus.ps1 | [Get-DomainStatus](./Get-DomainStatus/) |
| Join-Domain | Join-Domain.ps1 | [Join-Domain](./Join-Domain/) |
| New-LocalUserBulk | New-LocalUserBulk.ps1 | [New-LocalUserBulk](./New-LocalUserBulk/) |
| Remove-DomainJoin | Remove-DomainJoin.ps1 | [Remove-DomainJoin](./Remove-DomainJoin/) |
