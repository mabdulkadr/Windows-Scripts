...
**Get-ADDeviceDetails** is a PowerShell CLI tool in the **Identity-Access** category of the **Windows-Scripts** enterprise toolkit. Imports ActiveDirectory and retrieves all properties for the supplied computer name.

**Category:** `Identity-Access`
**Script:** `Get-ADDeviceDetails.ps1`
**Path:** `Identity-Access\Get-ADDeviceDetails\Get-ADDeviceDetails.ps1`
...
```powershell
Get-Help .\Get-ADDeviceDetails.ps1 -Full
Get-Help .\Get-ADDeviceDetails.ps1 -Examples
```

### Dry Run

```powershell
.\Get-ADDeviceDetails.ps1 -WhatIf
```
...
|-----------|------|----------|---------|-------------|
| — | — | — | — | Run `Get-Help .\Get-ADDeviceDetails.ps1 -Full` for parameter documentation |
