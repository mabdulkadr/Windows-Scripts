...
**Join-Domain** is a PowerShell CLI tool in the **Identity-Access** category of the **Windows-Scripts** enterprise toolkit. Calls Add-Computer with -DomainName and supplied -Credential, then restarts the computer.

**Category:** `Identity-Access`
**Script:** `Join-Domain.ps1`
**Path:** `Identity-Access\Join-Domain\Join-Domain.ps1`
...
```powershell
Get-Help .\Join-Domain.ps1 -Full
Get-Help .\Join-Domain.ps1 -Examples
```

### Dry Run

```powershell
.\Join-Domain.ps1 -WhatIf
```
...
|-----------|------|----------|---------|-------------|
| — | — | — | — | Run `Get-Help .\Join-Domain.ps1 -Full` for parameter documentation |
