...
**Remove-DomainJoin** is a PowerShell CLI tool in the **Identity-Access** category of the **Windows-Scripts** enterprise toolkit. Calls Remove-Computer with the supplied -Credential and restarts.

**Category:** `Identity-Access`
**Script:** `Remove-DomainJoin.ps1`
**Path:** `Identity-Access\Remove-DomainJoin\Remove-DomainJoin.ps1`
...
```powershell
Get-Help .\Remove-DomainJoin.ps1 -Full
Get-Help .\Remove-DomainJoin.ps1 -Examples
```

### Dry Run

```powershell
.\Remove-DomainJoin.ps1 -WhatIf
```
...
|-----------|------|----------|---------|-------------|
| — | — | — | — | Run `Get-Help .\Remove-DomainJoin.ps1 -Full` for parameter documentation |
