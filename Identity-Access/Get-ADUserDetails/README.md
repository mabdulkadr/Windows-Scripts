...
**Get-ADUserDetails** is a PowerShell CLI tool in the **Identity-Access** category of the **Windows-Scripts** enterprise toolkit. Imports ActiveDirectory and retrieves all properties for the supplied SamAccountName.

**Category:** `Identity-Access`
**Script:** `Get-ADUserDetails.ps1`
**Path:** `Identity-Access\Get-ADUserDetails\Get-ADUserDetails.ps1`
...
```powershell
Get-Help .\Get-ADUserDetails.ps1 -Full
Get-Help .\Get-ADUserDetails.ps1 -Examples
```

### Dry Run

```powershell
.\Get-ADUserDetails.ps1 -WhatIf
```
...
|-----------|------|----------|---------|-------------|
| — | — | — | — | Run `Get-Help .\Get-ADUserDetails.ps1 -Full` for parameter documentation |
