...
**Get-DomainStatus** is a PowerShell CLI tool in the **Identity-Access** category of the **Windows-Scripts** enterprise toolkit. Queries Win32_ComputerSystem to surface domain, role, and current user.

**Category:** `Identity-Access`
**Script:** `Get-DomainStatus.ps1`
**Path:** `Identity-Access\Get-DomainStatus\Get-DomainStatus.ps1`
...
```powershell
Get-Help .\Get-DomainStatus.ps1 -Full
Get-Help .\Get-DomainStatus.ps1 -Examples
```

### Dry Run

```powershell
.\Get-DomainStatus.ps1 -WhatIf
```
...
|-----------|------|----------|---------|-------------|
| — | — | — | — | Run `Get-Help .\Get-DomainStatus.ps1 -Full` for parameter documentation |
