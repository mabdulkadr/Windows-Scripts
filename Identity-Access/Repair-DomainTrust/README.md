...
**Repair-DomainTrust** is a PowerShell CLI tool in the **Identity-Access** category of the **Windows-Scripts** enterprise toolkit. Calls Test-ComputerSecureChannel -Repair to recover a broken trust.

**Category:** `Identity-Access`
**Script:** `Repair-DomainTrust.ps1`
**Path:** `Identity-Access\Repair-DomainTrust\Repair-DomainTrust.ps1`
...
```powershell
Get-Help .\Repair-DomainTrust.ps1 -Full
Get-Help .\Repair-DomainTrust.ps1 -Examples
```

### Dry Run

```powershell
.\Repair-DomainTrust.ps1 -WhatIf
```
...
|-----------|------|----------|---------|-------------|
| — | — | — | — | Run `Get-Help .\Repair-DomainTrust.ps1 -Full` for parameter documentation |
