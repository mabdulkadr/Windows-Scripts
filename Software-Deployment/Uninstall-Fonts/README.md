...
**Uninstall-Fonts** is a PowerShell CLI tool in the **Software-Deployment** category of the **Windows-Scripts** enterprise toolkit. Deletes every TTF/OTF in the Fonts folder and clears the registry entries.

**Category:** `Software-Deployment`
**Script:** `Uninstall-Fonts.ps1`
**Path:** `Software-Deployment\Uninstall-Fonts\Uninstall-Fonts.ps1`
...
```powershell
Get-Help .\Uninstall-Fonts.ps1 -Full
Get-Help .\Uninstall-Fonts.ps1 -Examples
```

### Dry Run

```powershell
.\Uninstall-Fonts.ps1 -WhatIf
```
...
|-----------|------|----------|---------|-------------|
| — | — | — | — | Run `Get-Help .\Uninstall-Fonts.ps1 -Full` for parameter documentation |
