...
**Install-WinGetApp** is a PowerShell CLI tool in the **Software-Deployment** category of the **Windows-Scripts** enterprise toolkit. Installs one or more apps via WinGet (winget install --silent) with bulk support. Checks winget availability, skips already-installed packages, and supports -WhatIf preview.

**Category:** `Software-Deployment`
**Script:** `Install-WinGetApp.ps1`
**Path:** `Software-Deployment\Install-WinGetApp\Install-WinGetApp.ps1`
...
```powershell
Get-Help .\Install-WinGetApp.ps1 -Full
Get-Help .\Install-WinGetApp.ps1 -Examples
```

### Dry Run

```powershell
.\Install-WinGetApp.ps1 -WhatIf
```
...
|-----------|------|----------|---------|-------------|
| — | — | — | — | Run `Get-Help .\Install-WinGetApp.ps1 -Full` for parameter documentation |
...
* **Permissions:** Administrator recommended; Standard user for per-user installs
