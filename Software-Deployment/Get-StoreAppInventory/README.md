...
**Get-StoreAppInventory** is a PowerShell CLI tool in the **Software-Deployment** category of the **Windows-Scripts** enterprise toolkit. Enumerates AppX packages via Get-AppxPackage for all users, reports Name, Version, Publisher, and InstallLocation. Exports CSV to Reports beside script.

**Category:** `Software-Deployment`
**Script:** `Get-StoreAppInventory.ps1`
**Path:** `Software-Deployment\Get-StoreAppInventory\Get-StoreAppInventory.ps1`
...
```powershell
Get-Help .\Get-StoreAppInventory.ps1 -Full
Get-Help .\Get-StoreAppInventory.ps1 -Examples
```

### Dry Run

```powershell
.\Get-StoreAppInventory.ps1 -WhatIf
```
...
|-----------|------|----------|---------|-------------|
| — | — | — | — | Run `Get-Help .\Get-StoreAppInventory.ps1 -Full` for parameter documentation |
