...
**Install-Fonts** is a PowerShell CLI tool in the **Software-Deployment** category of the **Windows-Scripts** enterprise toolkit. Copies every TTF/OTF in the supplied folder to the Fonts directory via Shell.Application.

**Category:** `Software-Deployment`
**Script:** `Install-Fonts.ps1`
**Path:** `Software-Deployment\Install-Fonts\Install-Fonts.ps1`
...
```powershell
Get-Help .\Install-Fonts.ps1 -Full
Get-Help .\Install-Fonts.ps1 -Examples
```

### Dry Run

```powershell
.\Install-Fonts.ps1 -WhatIf
```
...
|-----------|------|----------|---------|-------------|
| — | — | — | — | Run `Get-Help .\Install-Fonts.ps1 -Full` for parameter documentation |
