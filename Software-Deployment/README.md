...
# 📂 Software-Deployment
**Software Deployment — font install / uninstall — 4 tools**
...
**Software-Deployment** contains **4 PowerShell CLI tools** for software deployment — font install / uninstall.
...
* **2 Isolated Tools** — each in `Software-Deployment/ScriptName/` with `README.md`
...
| Install-WinGetApp | Install-WinGetApp.ps1 | [Install-WinGetApp](./Install-WinGetApp/) |
...
.\Software-Deployment\Install-Fonts\Install-Fonts.ps1
.\Software-Deployment\Install-Fonts\Install-Fonts.ps1 -WhatIf

# Help
Get-Help .\Software-Deployment\Install-Fonts\Install-Fonts.ps1 -Full
```
