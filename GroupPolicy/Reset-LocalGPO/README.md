...
**Reset-LocalGPO** is a PowerShell CLI tool in the **GroupPolicy** category of the **Windows-Scripts** enterprise toolkit. Runs LGPO /refreshpolicy to reset local policy to defaults.

**Category:** `GroupPolicy`
**Script:** `Reset-LocalGPO.ps1`
**Path:** `GroupPolicy\Reset-LocalGPO\Reset-LocalGPO.ps1`
...
```powershell
Get-Help .\Reset-LocalGPO.ps1 -Full
Get-Help .\Reset-LocalGPO.ps1 -Examples
```

### Dry Run

```powershell
.\Reset-LocalGPO.ps1 -WhatIf
```
...
|-----------|------|----------|---------|-------------|
| — | — | — | — | Run `Get-Help .\Reset-LocalGPO.ps1 -Full` for parameter documentation |
