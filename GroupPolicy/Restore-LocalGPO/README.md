...
**Restore-LocalGPO** is a PowerShell CLI tool in the **GroupPolicy** category of the **Windows-Scripts** enterprise toolkit. Runs LGPO.exe /r against a previously saved backup folder.

**Category:** `GroupPolicy`
**Script:** `Restore-LocalGPO.ps1`
**Path:** `GroupPolicy\Restore-LocalGPO\Restore-LocalGPO.ps1`
...
```powershell
Get-Help .\Restore-LocalGPO.ps1 -Full
Get-Help .\Restore-LocalGPO.ps1 -Examples
```

### Dry Run

```powershell
.\Restore-LocalGPO.ps1 -WhatIf
```
...
|-----------|------|----------|---------|-------------|
| — | — | — | — | Run `Get-Help .\Restore-LocalGPO.ps1 -Full` for parameter documentation |
