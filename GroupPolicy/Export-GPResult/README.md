...
**Export-GPResult** is a PowerShell CLI tool in the **GroupPolicy** category of the **Windows-Scripts** enterprise toolkit. Runs gpresult /h to write an HTML RSoP report under Reports/.

**Category:** `GroupPolicy`
**Script:** `Export-GPResult.ps1`
**Path:** `GroupPolicy\Export-GPResult\Export-GPResult.ps1`
...
```powershell
Get-Help .\Export-GPResult.ps1 -Full
Get-Help .\Export-GPResult.ps1 -Examples
```

### Dry Run

```powershell
.\Export-GPResult.ps1 -WhatIf
```
...
|-----------|------|----------|---------|-------------|
| — | — | — | — | Run `Get-Help .\Export-GPResult.ps1 -Full` for parameter documentation |
