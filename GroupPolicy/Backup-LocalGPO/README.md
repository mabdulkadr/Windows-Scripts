...
**Backup-LocalGPO** is a PowerShell CLI tool in the **GroupPolicy** category of the **Windows-Scripts** enterprise toolkit. Runs LGPO.exe /b to save a Local GPO backup to the supplied path.

**Category:** `GroupPolicy`
**Script:** `Backup-LocalGPO.ps1`
**Path:** `GroupPolicy\Backup-LocalGPO\Backup-LocalGPO.ps1`
...
```powershell
Get-Help .\Backup-LocalGPO.ps1 -Full
Get-Help .\Backup-LocalGPO.ps1 -Examples
```

### Dry Run

```powershell
.\Backup-LocalGPO.ps1 -WhatIf
```
...
|-----------|------|----------|---------|-------------|
| — | — | — | — | Run `Get-Help .\Backup-LocalGPO.ps1 -Full` for parameter documentation |
