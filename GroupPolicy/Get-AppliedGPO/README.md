...
**Get-AppliedGPO** is a PowerShell CLI tool in the **GroupPolicy** category of the **Windows-Scripts** enterprise toolkit. Combines Get-GPResultantSetOfPolicy and Get-GPResultantPolicy to list applied GPOs.

**Category:** `GroupPolicy`
**Script:** `Get-AppliedGPO.ps1`
**Path:** `GroupPolicy\Get-AppliedGPO\Get-AppliedGPO.ps1`
...
```powershell
Get-Help .\Get-AppliedGPO.ps1 -Full
Get-Help .\Get-AppliedGPO.ps1 -Examples
```

### Dry Run

```powershell
.\Get-AppliedGPO.ps1 -WhatIf
```
...
|-----------|------|----------|---------|-------------|
| — | — | — | — | Run `Get-Help .\Get-AppliedGPO.ps1 -Full` for parameter documentation |
