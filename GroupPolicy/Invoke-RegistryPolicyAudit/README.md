...
**Invoke-RegistryPolicyAudit** is a PowerShell CLI tool in the **GroupPolicy** category of the **Windows-Scripts** enterprise toolkit. Imports a CliXML baseline and reports drift in HKLM\SOFTWARE\Policies keys.

**Category:** `GroupPolicy`
**Script:** `Invoke-RegistryPolicyAudit.ps1`
**Path:** `GroupPolicy\Invoke-RegistryPolicyAudit\Invoke-RegistryPolicyAudit.ps1`
...
```powershell
Get-Help .\Invoke-RegistryPolicyAudit.ps1 -Full
Get-Help .\Invoke-RegistryPolicyAudit.ps1 -Examples
```

### Dry Run

```powershell
.\Invoke-RegistryPolicyAudit.ps1 -WhatIf
```
...
|-----------|------|----------|---------|-------------|
| — | — | — | — | Run `Get-Help .\Invoke-RegistryPolicyAudit.ps1 -Full` for parameter documentation |
