...
# 📂 GroupPolicy
**Group Policy - backup, restore, audit and refresh - 6 tools**
...
**GroupPolicy** contains **6 PowerShell CLI tools** for Group Policy - backup, restore, audit and refresh.
...
* **6 Isolated Tools** - each in `GroupPolicy/ScriptName/` with `README.md`
