...
**Invoke-IntuneReenrollment** is a PowerShell CLI tool in the **Endpoint-Management** category of the **Windows-Scripts** enterprise toolkit. Clears the Autopilot cache and forces a re-enrollment at the next ESP run.

**Category:** `Endpoint-Management`
**Script:** `Invoke-IntuneReenrollment.ps1`
**Path:** `Endpoint-Management\Invoke-IntuneReenrollment\Invoke-IntuneReenrollment.ps1`
...
```powershell
Get-Help .\Invoke-IntuneReenrollment.ps1 -Full
Get-Help .\Invoke-IntuneReenrollment.ps1 -Examples
```

### Dry Run

```powershell
.\Invoke-IntuneReenrollment.ps1 -WhatIf
```
...
|-----------|------|----------|---------|-------------|
| — | — | — | — | Run `Get-Help .\Invoke-IntuneReenrollment.ps1 -Full` for parameter documentation |
