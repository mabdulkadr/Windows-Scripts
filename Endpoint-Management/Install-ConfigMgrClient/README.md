...
**Install-ConfigMgrClient** is a PowerShell CLI tool in the **Endpoint-Management** category of the **Windows-Scripts** enterprise toolkit. Detects CcmExec; if missing, triggers ccmsetup from the assigned MP and verifies the post-install service state.

**Category:** `Endpoint-Management`
**Script:** `Install-ConfigMgrClient.ps1`
**Path:** `Endpoint-Management\Install-ConfigMgrClient\Install-ConfigMgrClient.ps1`
...
```powershell
Get-Help .\Install-ConfigMgrClient.ps1 -Full
Get-Help .\Install-ConfigMgrClient.ps1 -Examples
```

### Dry Run

```powershell
.\Install-ConfigMgrClient.ps1 -WhatIf
```
...
|-----------|------|----------|---------|-------------|
| — | — | — | — | Run `Get-Help .\Install-ConfigMgrClient.ps1 -Full` for parameter documentation |
...
* **Permissions:** SYSTEM (Intune) or Administrator
