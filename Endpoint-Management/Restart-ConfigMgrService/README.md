...
**Restart-ConfigMgrService** is a PowerShell CLI tool in the **Endpoint-Management** category of the **Windows-Scripts** enterprise toolkit. Stops and starts the CcmExec service with -Force to recover stuck client.

**Category:** `Endpoint-Management`
**Script:** `Restart-ConfigMgrService.ps1`
**Path:** `Endpoint-Management\Restart-ConfigMgrService\Restart-ConfigMgrService.ps1`
...
```powershell
Get-Help .\Restart-ConfigMgrService.ps1 -Full
Get-Help .\Restart-ConfigMgrService.ps1 -Examples
```

### Dry Run

```powershell
.\Restart-ConfigMgrService.ps1 -WhatIf
```
...
|-----------|------|----------|---------|-------------|
| — | — | — | — | Run `Get-Help .\Restart-ConfigMgrService.ps1 -Full` for parameter documentation |
