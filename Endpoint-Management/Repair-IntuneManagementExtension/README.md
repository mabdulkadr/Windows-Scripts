...
**Repair-IntuneManagementExtension** is a PowerShell CLI tool in the **Endpoint-Management** category of the **Windows-Scripts** enterprise toolkit. Resets IME state, stops/starts the service, and clears the UserSideMDMState registry value.

**Category:** `Endpoint-Management`
**Script:** `Repair-IntuneManagementExtension.ps1`
**Path:** `Endpoint-Management\Repair-IntuneManagementExtension\Repair-IntuneManagementExtension.ps1`
...
```powershell
Get-Help .\Repair-IntuneManagementExtension.ps1 -Full
Get-Help .\Repair-IntuneManagementExtension.ps1 -Examples
```

### Dry Run

```powershell
.\Repair-IntuneManagementExtension.ps1 -WhatIf
```
...
|-----------|------|----------|---------|-------------|
| — | — | — | — | Run `Get-Help .\Repair-IntuneManagementExtension.ps1 -Full` for parameter documentation |
