...
**Restart-IntuneService** is a PowerShell CLI tool in the **Endpoint-Management** category of the **Windows-Scripts** enterprise toolkit. Restarts IntuneManagementExtension to recover IME.

**Category:** `Endpoint-Management`
**Script:** `Restart-IntuneService.ps1`
**Path:** `Endpoint-Management\Restart-IntuneService\Restart-IntuneService.ps1`
...
```powershell
Get-Help .\Restart-IntuneService.ps1 -Full
Get-Help .\Restart-IntuneService.ps1 -Examples
```

### Dry Run

```powershell
.\Restart-IntuneService.ps1 -WhatIf
```
...
|-----------|------|----------|---------|-------------|
| — | — | — | — | Run `Get-Help .\Restart-IntuneService.ps1 -Full` for parameter documentation |
