...
**Test-EndpointConnectivity** is a PowerShell CLI tool in the **Endpoint-Management** category of the **Windows-Scripts** enterprise toolkit. Opens TCP sockets to login.microsoftonline.com, manage.microsoft.com, graph.microsoft.com, and portal.azure.com and reports status per host.

**Category:** `Endpoint-Management`
**Script:** `Test-EndpointConnectivity.ps1`
**Path:** `Endpoint-Management\Test-EndpointConnectivity\Test-EndpointConnectivity.ps1`
...
```powershell
Get-Help .\Test-EndpointConnectivity.ps1 -Full
Get-Help .\Test-EndpointConnectivity.ps1 -Examples
```

### Dry Run

```powershell
.\Test-EndpointConnectivity.ps1 -WhatIf
```
...
|-----------|------|----------|---------|-------------|
| — | — | — | — | Run `Get-Help .\Test-EndpointConnectivity.ps1 -Full` for parameter documentation |
