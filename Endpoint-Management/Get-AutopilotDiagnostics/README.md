...
**Get-AutopilotDiagnostics** is a PowerShell CLI tool in the **Endpoint-Management** category of the **Windows-Scripts** enterprise toolkit. Checks Autopilot prerequisites: TPM, Autopilot profile registry, enrollment status, and hardware hash availability. Reports ready vs not ready.

**Category:** `Endpoint-Management`
**Script:** `Get-AutopilotDiagnostics.ps1`
**Path:** `Endpoint-Management\Get-AutopilotDiagnostics\Get-AutopilotDiagnostics.ps1`
...
```powershell
Get-Help .\Get-AutopilotDiagnostics.ps1 -Full
Get-Help .\Get-AutopilotDiagnostics.ps1 -Examples
```

### Dry Run

```powershell
.\Get-AutopilotDiagnostics.ps1 -WhatIf
```
...
|-----------|------|----------|---------|-------------|
| — | — | — | — | Run `Get-Help .\Get-AutopilotDiagnostics.ps1 -Full` for parameter documentation |
