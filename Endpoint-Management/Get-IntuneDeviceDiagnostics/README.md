...
**Get-IntuneDeviceDiagnostics** is a PowerShell CLI tool in the **Endpoint-Management** category of the **Windows-Scripts** enterprise toolkit. Collects local Intune diagnostics: enrollment, IME logs, Win32Apps, last sync, and exports CSV + HTML Carbon to Reports.

**Category:** `Endpoint-Management`
**Script:** `Get-IntuneDeviceDiagnostics.ps1`
**Path:** `Endpoint-Management\Get-IntuneDeviceDiagnostics\Get-IntuneDeviceDiagnostics.ps1`
...
```powershell
Get-Help .\Get-IntuneDeviceDiagnostics.ps1 -Full
Get-Help .\Get-IntuneDeviceDiagnostics.ps1 -Examples
```

### Dry Run

```powershell
.\Get-IntuneDeviceDiagnostics.ps1 -WhatIf
```
...
|-----------|------|----------|---------|-------------|
| — | — | — | — | Run `Get-Help .\Get-IntuneDeviceDiagnostics.ps1 -Full` for parameter documentation |
