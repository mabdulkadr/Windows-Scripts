...
# 📂 Endpoint-Management
**Endpoint Management - Intune, ConfigMgr, device sync and remediation - 8 tools**
...
**Endpoint-Management** contains **8 PowerShell CLI tools** for Endpoint Management - Intune, ConfigMgr, device sync and remediation.
...
* **8 Isolated Tools** - each in `Endpoint-Management/ScriptName/` with `README.md`
