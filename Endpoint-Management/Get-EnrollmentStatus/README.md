...
**Get-EnrollmentStatus** is a PowerShell CLI tool in the **Endpoint-Management** category of the **Windows-Scripts** enterprise toolkit. Queries MDM enrollment keys and emits a structured summary of each enrollment state, provider, and last check time.

**Category:** `Endpoint-Management`
**Script:** `Get-EnrollmentStatus.ps1`
**Path:** `Endpoint-Management\Get-EnrollmentStatus\Get-EnrollmentStatus.ps1`
...
```powershell
Get-Help .\Get-EnrollmentStatus.ps1 -Full
Get-Help .\Get-EnrollmentStatus.ps1 -Examples
```

### Dry Run

```powershell
.\Get-EnrollmentStatus.ps1 -WhatIf
```
...
|-----------|------|----------|---------|-------------|
| — | — | — | — | Run `Get-Help .\Get-EnrollmentStatus.ps1 -Full` for parameter documentation |
