...
**Sync-IntuneDevice** is a PowerShell CLI tool in the **Endpoint-Management** category of the **Windows-Scripts** enterprise toolkit. Restarts the IntuneManagementExtension service to force IME resync.

**Category:** `Endpoint-Management`
**Script:** `Sync-IntuneDevice.ps1`
**Path:** `Endpoint-Management\Sync-IntuneDevice\Sync-IntuneDevice.ps1`
...
```powershell
Get-Help .\Sync-IntuneDevice.ps1 -Full
Get-Help .\Sync-IntuneDevice.ps1 -Examples
```

### Dry Run

```powershell
.\Sync-IntuneDevice.ps1 -WhatIf
```
...
|-----------|------|----------|---------|-------------|
| — | — | — | — | Run `Get-Help .\Sync-IntuneDevice.ps1 -Full` for parameter documentation |
