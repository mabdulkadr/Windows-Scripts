...
**Invoke-SCCMActions** is a PowerShell CLI tool in the **Endpoint-Management** category of the **Windows-Scripts** enterprise toolkit. Invokes the requested WMI client action (e.g. Machine Policy, App Deployment) on the local ConfigMgr client.

**Category:** `Endpoint-Management`
**Script:** `Invoke-SCCMActions.ps1`
**Path:** `Endpoint-Management\Invoke-SCCMActions\Invoke-SCCMActions.ps1`
...
```powershell
Get-Help .\Invoke-SCCMActions.ps1 -Full
Get-Help .\Invoke-SCCMActions.ps1 -Examples
```

### Dry Run

```powershell
.\Invoke-SCCMActions.ps1 -WhatIf
```
...
|-----------|------|----------|---------|-------------|
| — | — | — | — | Run `Get-Help .\Invoke-SCCMActions.ps1 -Full` for parameter documentation |
