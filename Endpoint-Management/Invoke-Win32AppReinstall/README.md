...
**Invoke-Win32AppReinstall** is a PowerShell CLI tool in the **Endpoint-Management** category of the **Windows-Scripts** enterprise toolkit. Calls the Intune Win32 TriggerApplication method for every assigned application.

**Category:** `Endpoint-Management`
**Script:** `Invoke-Win32AppReinstall.ps1`
**Path:** `Endpoint-Management\Invoke-Win32AppReinstall\Invoke-Win32AppReinstall.ps1`
...
```powershell
Get-Help .\Invoke-Win32AppReinstall.ps1 -Full
Get-Help .\Invoke-Win32AppReinstall.ps1 -Examples
```

### Dry Run

```powershell
.\Invoke-Win32AppReinstall.ps1 -WhatIf
```
...
|-----------|------|----------|---------|-------------|
| — | — | — | — | Run `Get-Help .\Invoke-Win32AppReinstall.ps1 -Full` for parameter documentation |
