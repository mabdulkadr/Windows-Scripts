...
**Remove-RevokedRootCertificate** is a PowerShell CLI tool in the **Security-Compliance** category of the **Windows-Scripts** enterprise toolkit. Verifies every cert in LocalMachine\Root, removes revoked ones, and logs the count.

**Category:** `Security-Compliance`
**Script:** `Remove-RevokedRootCertificate.ps1`
**Path:** `Security-Compliance\Remove-RevokedRootCertificate\Remove-RevokedRootCertificate.ps1`
...
```powershell
Get-Help .\Remove-RevokedRootCertificate.ps1 -Full
Get-Help .\Remove-RevokedRootCertificate.ps1 -Examples
```

### Dry Run

```powershell
.\Remove-RevokedRootCertificate.ps1 -WhatIf
```
...
|-----------|------|----------|---------|-------------|
| — | — | — | — | Run `Get-Help .\Remove-RevokedRootCertificate.ps1 -Full` for parameter documentation |
