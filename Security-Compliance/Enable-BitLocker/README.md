...
**Enable-BitLocker** is a PowerShell CLI tool in the **Security-Compliance** category of the **Windows-Scripts** enterprise toolkit. Enables BitLocker on the OS volume with TPM protector when not already protected. Requires TPM 1.2+ and Administrator. Supports -WhatIf; skips already-encrypted volumes.

**Category:** `Security-Compliance`
**Script:** `Enable-BitLocker.ps1`
**Path:** `Security-Compliance\Enable-BitLocker\Enable-BitLocker.ps1`
...
```powershell
Get-Help .\Enable-BitLocker.ps1 -Full
Get-Help .\Enable-BitLocker.ps1 -Examples
```

### Dry Run

```powershell
.\Enable-BitLocker.ps1 -WhatIf
```
...
|-----------|------|----------|---------|-------------|
| — | — | — | — | Run `Get-Help .\Enable-BitLocker.ps1 -Full` for parameter documentation |
