...
**Get-DefenderHealth** is a PowerShell CLI tool in the **Security-Compliance** category of the **Windows-Scripts** enterprise toolkit. Checks WinDefend service, Get-MpComputerStatus fields (AntivirusEnabled, RealTimeProtection, SignatureAge, QuickScanAge), and reports healthy vs degraded.

**Category:** `Security-Compliance`
**Script:** `Get-DefenderHealth.ps1`
**Path:** `Security-Compliance\Get-DefenderHealth\Get-DefenderHealth.ps1`
...
```powershell
Get-Help .\Get-DefenderHealth.ps1 -Full
Get-Help .\Get-DefenderHealth.ps1 -Examples
```

### Dry Run

```powershell
.\Get-DefenderHealth.ps1 -WhatIf
```
...
|-----------|------|----------|---------|-------------|
| — | — | — | — | Run `Get-Help .\Get-DefenderHealth.ps1 -Full` for parameter documentation |
