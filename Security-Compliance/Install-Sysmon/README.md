...
**Install-Sysmon** is a PowerShell CLI tool in the **Security-Compliance** category of the **Windows-Scripts** enterprise toolkit. Runs Config/Sysmon64.exe -accepteula -i Config/sysmonconfig.xml from the script folder.

**Category:** `Security-Compliance`
**Script:** `Install-Sysmon.ps1`
**Path:** `Security-Compliance\Install-Sysmon\Install-Sysmon.ps1`
...
```powershell
Get-Help .\Install-Sysmon.ps1 -Full
Get-Help .\Install-Sysmon.ps1 -Examples
```

### Dry Run

```powershell
.\Install-Sysmon.ps1 -WhatIf
```
...
|-----------|------|----------|---------|-------------|
| — | — | — | — | Run `Get-Help .\Install-Sysmon.ps1 -Full` for parameter documentation |
