...
**Get-BitLockerStatus** is a PowerShell CLI tool in the **Security-Compliance** category of the **Windows-Scripts** enterprise toolkit. Queries Get-BitLockerVolume for all fixed volumes and reports ProtectionStatus, EncryptionPercentage, and KeyProtector types.

**Category:** `Security-Compliance`
**Script:** `Get-BitLockerStatus.ps1`
**Path:** `Security-Compliance\Get-BitLockerStatus\Get-BitLockerStatus.ps1`
...
```powershell
Get-Help .\Get-BitLockerStatus.ps1 -Full
Get-Help .\Get-BitLockerStatus.ps1 -Examples
```

### Dry Run

```powershell
.\Get-BitLockerStatus.ps1 -WhatIf
```
...
|-----------|------|----------|---------|-------------|
| — | — | — | — | Run `Get-Help .\Get-BitLockerStatus.ps1 -Full` for parameter documentation |
...
* **Permissions:** Standard user for status; Administrator for protector details
