...
**Get-AttackSurfaceReduction** is a PowerShell CLI tool in the **Security-Compliance** category of the **Windows-Scripts** enterprise toolkit. Enumerates Attack Surface Reduction (ASR) rules via Get-MpPreference (AttackSurfaceReductionRules_Ids/Actions) and Defender exclusions. Reports audit vs block vs disabled.

**Category:** `Security-Compliance`
**Script:** `Get-AttackSurfaceReduction.ps1`
**Path:** `Security-Compliance\Get-AttackSurfaceReduction\Get-AttackSurfaceReduction.ps1`
...
```powershell
Get-Help .\Get-AttackSurfaceReduction.ps1 -Full
Get-Help .\Get-AttackSurfaceReduction.ps1 -Examples
```

### Dry Run

```powershell
.\Get-AttackSurfaceReduction.ps1 -WhatIf
```
...
|-----------|------|----------|---------|-------------|
| — | — | — | — | Run `Get-Help .\Get-AttackSurfaceReduction.ps1 -Full` for parameter documentation |
