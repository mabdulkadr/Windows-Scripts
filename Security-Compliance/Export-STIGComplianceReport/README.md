...
**Export-STIGComplianceReport** is a PowerShell CLI tool in the **Security-Compliance** category of the **Windows-Scripts** enterprise toolkit. Audits 12 hardening checks (Defender, Firewall, BitLocker, LAPS, SecureBoot, ASR, etc.) and exports Carbon Dark HTML + CSV to Reports. Scores 0-100 with grade.

**Category:** `Security-Compliance`
**Script:** `Export-STIGComplianceReport.ps1`
**Path:** `Security-Compliance\Export-STIGComplianceReport\Export-STIGComplianceReport.ps1`
...
```powershell
Get-Help .\Export-STIGComplianceReport.ps1 -Full
Get-Help .\Export-STIGComplianceReport.ps1 -Examples
```

### Dry Run

```powershell
.\Export-STIGComplianceReport.ps1 -WhatIf
```
...
|-----------|------|----------|---------|-------------|
| — | — | — | — | Run `Get-Help .\Export-STIGComplianceReport.ps1 -Full` for parameter documentation |
...
* **Permissions:** Standard user (some checks need Administrator)
