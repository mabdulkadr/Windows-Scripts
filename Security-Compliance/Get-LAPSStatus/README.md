...
**Get-LAPSStatus** is a PowerShell CLI tool in the **Security-Compliance** category of the **Windows-Scripts** enterprise toolkit. Checks LAPS policy (BackupDirectory, PasswordAge, AutomaticAccount) and reports compliance. No changes made.

**Category:** `Security-Compliance`
**Script:** `Get-LAPSStatus.ps1`
**Path:** `Security-Compliance\Get-LAPSStatus\Get-LAPSStatus.ps1`
...
```powershell
Get-Help .\Get-LAPSStatus.ps1 -Full
Get-Help .\Get-LAPSStatus.ps1 -Examples
```

### Dry Run

```powershell
.\Get-LAPSStatus.ps1 -WhatIf
```
...
|-----------|------|----------|---------|-------------|
| — | — | — | — | Run `Get-Help .\Get-LAPSStatus.ps1 -Full` for parameter documentation |
...
* **Permissions:** Standard user for local policy; AD read for expiry
