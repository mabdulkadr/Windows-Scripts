...
**Test-SecureBoot** is a PowerShell CLI tool in the **Security-Compliance** category of the **Windows-Scripts** enterprise toolkit. Checks Secure Boot state (Confirm-SecureBootUEFI), TPM presence (Get-Tpm), and reports compliant vs not compliant for Conditional Access.

**Category:** `Security-Compliance`
**Script:** `Test-SecureBoot.ps1`
**Path:** `Security-Compliance\Test-SecureBoot\Test-SecureBoot.ps1`
...
```powershell
Get-Help .\Test-SecureBoot.ps1 -Full
Get-Help .\Test-SecureBoot.ps1 -Examples
```

### Dry Run

```powershell
.\Test-SecureBoot.ps1 -WhatIf
```
...
|-----------|------|----------|---------|-------------|
| — | — | — | — | Run `Get-Help .\Test-SecureBoot.ps1 -Full` for parameter documentation |
