...
**Get-WiFiPassword** is a PowerShell CLI tool in the **Network** category of the **Windows-Scripts** enterprise toolkit. Enumerates saved Wi-Fi profiles via netsh wlan show profiles and extracts cleartext passwords (key=clear) for audit. Requires Administrator for password reveal.

**Category:** `Network`
**Script:** `Get-WiFiPassword.ps1`
**Path:** `Network\Get-WiFiPassword\Get-WiFiPassword.ps1`
...
```powershell
Get-Help .\Get-WiFiPassword.ps1 -Full
Get-Help .\Get-WiFiPassword.ps1 -Examples
```

### Dry Run

```powershell
.\Get-WiFiPassword.ps1 -WhatIf
```
...
|-----------|------|----------|---------|-------------|
| — | — | — | — | Run `Get-Help .\Get-WiFiPassword.ps1 -Full` for parameter documentation |
...
* **Permissions:** Administrator for passwords; Standard user for SSID list
