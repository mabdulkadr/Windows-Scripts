...
**Disable-IPv6** is a PowerShell CLI tool in the **Network** category of the **Windows-Scripts** enterprise toolkit. Calls Disable-NetAdapterBinding to remove the ms_tcpip6 component from all adapters.

**Category:** `Network`
**Script:** `Disable-IPv6.ps1`
**Path:** `Network\Disable-IPv6\Disable-IPv6.ps1`
...
```powershell
Get-Help .\Disable-IPv6.ps1 -Full
Get-Help .\Disable-IPv6.ps1 -Examples
```

### Dry Run

```powershell
.\Disable-IPv6.ps1 -WhatIf
```
...
|-----------|------|----------|---------|-------------|
| — | — | — | — | Run `Get-Help .\Disable-IPv6.ps1 -Full` for parameter documentation |
