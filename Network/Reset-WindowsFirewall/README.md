...
**Reset-WindowsFirewall** is a PowerShell CLI tool in the **Network** category of the **Windows-Scripts** enterprise toolkit. Runs netsh advfirewall reset to restore the default firewall configuration.

**Category:** `Network`
**Script:** `Reset-WindowsFirewall.ps1`
**Path:** `Network\Reset-WindowsFirewall\Reset-WindowsFirewall.ps1`
...
```powershell
Get-Help .\Reset-WindowsFirewall.ps1 -Full
Get-Help .\Reset-WindowsFirewall.ps1 -Examples
```

### Dry Run

```powershell
.\Reset-WindowsFirewall.ps1 -WhatIf
```
...
|-----------|------|----------|---------|-------------|
| — | — | — | — | Run `Get-Help .\Reset-WindowsFirewall.ps1 -Full` for parameter documentation |
