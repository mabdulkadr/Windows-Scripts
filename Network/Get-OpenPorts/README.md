...
**Get-OpenPorts** is a PowerShell CLI tool in the **Network** category of the **Windows-Scripts** enterprise toolkit. Combines Get-NetTCPConnection (Listen) and Get-NetUDPEndpoint to surface local listening ports.

**Category:** `Network`
**Script:** `Get-OpenPorts.ps1`
**Path:** `Network\Get-OpenPorts\Get-OpenPorts.ps1`
...
```powershell
Get-Help .\Get-OpenPorts.ps1 -Full
Get-Help .\Get-OpenPorts.ps1 -Examples
```

### Dry Run

```powershell
.\Get-OpenPorts.ps1 -WhatIf
```
...
|-----------|------|----------|---------|-------------|
| — | — | — | — | Run `Get-Help .\Get-OpenPorts.ps1 -Full` for parameter documentation |
