...
**Test-NetworkLatency** is a PowerShell CLI tool in the **Network** category of the **Windows-Scripts** enterprise toolkit. Pings targets (default 8.8.8.8, 1.1.1.1, microsoft.com) 4 times each, reports avg/min/max latency and packet loss.

**Category:** `Network`
**Script:** `Test-NetworkLatency.ps1`
**Path:** `Network\Test-NetworkLatency\Test-NetworkLatency.ps1`
...
```powershell
Get-Help .\Test-NetworkLatency.ps1 -Full
Get-Help .\Test-NetworkLatency.ps1 -Examples
```

### Dry Run

```powershell
.\Test-NetworkLatency.ps1 -WhatIf
```
...
|-----------|------|----------|---------|-------------|
| — | — | — | — | Run `Get-Help .\Test-NetworkLatency.ps1 -Full` for parameter documentation |
