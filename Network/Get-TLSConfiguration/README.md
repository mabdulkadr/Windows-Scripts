...
**Get-TLSConfiguration** is a PowerShell CLI tool in the **Network** category of the **Windows-Scripts** enterprise toolkit. Reports which TLS versions are enabled in the SCHANNEL registry.

**Category:** `Network`
**Script:** `Get-TLSConfiguration.ps1`
**Path:** `Network\Get-TLSConfiguration\Get-TLSConfiguration.ps1`
...
```powershell
Get-Help .\Get-TLSConfiguration.ps1 -Full
Get-Help .\Get-TLSConfiguration.ps1 -Examples
```

### Dry Run

```powershell
.\Get-TLSConfiguration.ps1 -WhatIf
```
...
|-----------|------|----------|---------|-------------|
| — | — | — | — | Run `Get-Help .\Get-TLSConfiguration.ps1 -Full` for parameter documentation |
