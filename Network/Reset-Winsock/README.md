...
**Reset-Winsock** is a PowerShell CLI tool in the **Network** category of the **Windows-Scripts** enterprise toolkit. Runs netsh winsock reset to recover the network stack.

**Category:** `Network`
**Script:** `Reset-Winsock.ps1`
**Path:** `Network\Reset-Winsock\Reset-Winsock.ps1`
...
```powershell
Get-Help .\Reset-Winsock.ps1 -Full
Get-Help .\Reset-Winsock.ps1 -Examples
```

### Dry Run

```powershell
.\Reset-Winsock.ps1 -WhatIf
```
...
|-----------|------|----------|---------|-------------|
| — | — | — | — | Run `Get-Help .\Reset-Winsock.ps1 -Full` for parameter documentation |
