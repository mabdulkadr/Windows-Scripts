...
**Clear-DnsCache** is a PowerShell CLI tool in the **Network** category of the **Windows-Scripts** enterprise toolkit. Runs ipconfig /flushdns and confirms the cache is empty.

**Category:** `Network`
**Script:** `Clear-DnsCache.ps1`
**Path:** `Network\Clear-DnsCache\Clear-DnsCache.ps1`
...
```powershell
Get-Help .\Clear-DnsCache.ps1 -Full
Get-Help .\Clear-DnsCache.ps1 -Examples
```

### Dry Run

```powershell
.\Clear-DnsCache.ps1 -WhatIf
```
...
|-----------|------|----------|---------|-------------|
| — | — | — | — | Run `Get-Help .\Clear-DnsCache.ps1 -Full` for parameter documentation |
