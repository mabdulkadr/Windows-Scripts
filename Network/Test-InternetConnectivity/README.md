...
**Test-InternetConnectivity** is a PowerShell CLI tool in the **Network** category of the **Windows-Scripts** enterprise toolkit. Uses Invoke-WebRequest to verify reachability of Microsoft endpoints.

**Category:** `Network`
**Script:** `Test-InternetConnectivity.ps1`
**Path:** `Network\Test-InternetConnectivity\Test-InternetConnectivity.ps1`
...
```powershell
Get-Help .\Test-InternetConnectivity.ps1 -Full
Get-Help .\Test-InternetConnectivity.ps1 -Examples
```

### Dry Run

```powershell
.\Test-InternetConnectivity.ps1 -WhatIf
```
...
|-----------|------|----------|---------|-------------|
| — | — | — | — | Run `Get-Help .\Test-InternetConnectivity.ps1 -Full` for parameter documentation |
