...
**Disable-WindowsFirewall** is a PowerShell CLI tool in the **Network** category of the **Windows-Scripts** enterprise toolkit. Calls Set-NetFirewallProfile with -Enabled False on every profile.

**Category:** `Network`
**Script:** `Disable-WindowsFirewall.ps1`
**Path:** `Network\Disable-WindowsFirewall\Disable-WindowsFirewall.ps1`
...
```powershell
Get-Help .\Disable-WindowsFirewall.ps1 -Full
Get-Help .\Disable-WindowsFirewall.ps1 -Examples
```

### Dry Run

```powershell
.\Disable-WindowsFirewall.ps1 -WhatIf
```
...
|-----------|------|----------|---------|-------------|
| — | — | — | — | Run `Get-Help .\Disable-WindowsFirewall.ps1 -Full` for parameter documentation |
