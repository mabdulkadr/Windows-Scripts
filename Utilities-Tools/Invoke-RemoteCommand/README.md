...
**Invoke-RemoteCommand** is a PowerShell CLI tool in the **Utilities-Tools** category of the **Windows-Scripts** enterprise toolkit. Runs a PowerShell ScriptBlock on one or more remote machines via WinRM (Invoke-Command). Supports bulk -TargetName list, parallel ThrottleLimit, and -WhatIf preview.

**Category:** `Utilities-Tools`
**Script:** `Invoke-RemoteCommand.ps1`
**Path:** `Utilities-Tools\Invoke-RemoteCommand\Invoke-RemoteCommand.ps1`
...
```powershell
Get-Help .\Invoke-RemoteCommand.ps1 -Full
Get-Help .\Invoke-RemoteCommand.ps1 -Examples
```

### Dry Run

```powershell
.\Invoke-RemoteCommand.ps1 -WhatIf
```
...
|-----------|------|----------|---------|-------------|
| — | — | — | — | Run `Get-Help .\Invoke-RemoteCommand.ps1 -Full` for parameter documentation |
...
* **Permissions:** Administrator on remote (delegated)
