...
**Get-ScheduledTaskReport** is a PowerShell CLI tool in the **Utilities-Tools** category of the **Windows-Scripts** enterprise toolkit. Enumerates scheduled tasks, flags non-Microsoft publishers and tasks with suspicious actions (powershell, rundll32, mshta).

**Category:** `Utilities-Tools`
**Script:** `Get-ScheduledTaskReport.ps1`
**Path:** `Utilities-Tools\Get-ScheduledTaskReport\Get-ScheduledTaskReport.ps1`
...
```powershell
Get-Help .\Get-ScheduledTaskReport.ps1 -Full
Get-Help .\Get-ScheduledTaskReport.ps1 -Examples
```

### Dry Run

```powershell
.\Get-ScheduledTaskReport.ps1 -WhatIf
```
...
|-----------|------|----------|---------|-------------|
| — | — | — | — | Run `Get-Help .\Get-ScheduledTaskReport.ps1 -Full` for parameter documentation |
