...
**Invoke-RunAsAdmin** is a PowerShell CLI tool in the **Utilities-Tools** category of the **Windows-Scripts** enterprise toolkit. Re-elevates the supplied command via Start-Process -Verb RunAs.

**Category:** `Utilities-Tools`
**Script:** `Invoke-RunAsAdmin.ps1`
**Path:** `Utilities-Tools\Invoke-RunAsAdmin\Invoke-RunAsAdmin.ps1`
...
```powershell
Get-Help .\Invoke-RunAsAdmin.ps1 -Full
Get-Help .\Invoke-RunAsAdmin.ps1 -Examples
```

### Dry Run

```powershell
.\Invoke-RunAsAdmin.ps1 -WhatIf
```
...
|-----------|------|----------|---------|-------------|
| — | — | — | — | Run `Get-Help .\Invoke-RunAsAdmin.ps1 -Full` for parameter documentation |
