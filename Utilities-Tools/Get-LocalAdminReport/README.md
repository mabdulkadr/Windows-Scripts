...
**Get-LocalAdminReport** is a PowerShell CLI tool in the **Utilities-Tools** category of the **Windows-Scripts** enterprise toolkit. Enumerates local Administrators group members, flags dormant accounts, Guest, and unknown SIDs. Supports remote via WinRM.

**Category:** `Utilities-Tools`
**Script:** `Get-LocalAdminReport.ps1`
**Path:** `Utilities-Tools\Get-LocalAdminReport\Get-LocalAdminReport.ps1`
...
```powershell
Get-Help .\Get-LocalAdminReport.ps1 -Full
Get-Help .\Get-LocalAdminReport.ps1 -Examples
```

### Dry Run

```powershell
.\Get-LocalAdminReport.ps1 -WhatIf
```
...
|-----------|------|----------|---------|-------------|
| — | — | — | — | Run `Get-Help .\Get-LocalAdminReport.ps1 -Full` for parameter documentation |
