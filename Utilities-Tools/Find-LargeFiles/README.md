...
**Find-LargeFiles** is a PowerShell CLI tool in the **Utilities-Tools** category of the **Windows-Scripts** enterprise toolkit. Scans a directory recursively for largest files (default Top 20), reports size, and exports CSV to Reports. Supports -WhatIf (no export).

**Category:** `Utilities-Tools`
**Script:** `Find-LargeFiles.ps1`
**Path:** `Utilities-Tools\Find-LargeFiles\Find-LargeFiles.ps1`
...
```powershell
Get-Help .\Find-LargeFiles.ps1 -Full
Get-Help .\Find-LargeFiles.ps1 -Examples
```

### Dry Run

```powershell
.\Find-LargeFiles.ps1 -WhatIf
```
...
|-----------|------|----------|---------|-------------|
| — | — | — | — | Run `Get-Help .\Find-LargeFiles.ps1 -Full` for parameter documentation |
...
* **Permissions:** Standard user (some folders need elevation)
