...
# 📂 Utilities-Tools
**Utilities and Tools - file analysis, admin reports and elevation helpers - 5 tools**
...
**Utilities-Tools** contains **5 PowerShell CLI tools** for Utilities and Tools - file analysis, admin reports and elevation helpers.
...
* **5 Isolated Tools** - each in `Utilities-Tools/ScriptName/` with `README.md`
...
.\Utilities-Tools\Find-LargeFiles\Find-LargeFiles.ps1
.\Utilities-Tools\Find-LargeFiles\Find-LargeFiles.ps1 -WhatIf

# Help
Get-Help .\Utilities-Tools\Find-LargeFiles\Find-LargeFiles.ps1 -Full
```
