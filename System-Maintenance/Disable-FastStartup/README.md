...
**Disable-FastStartup** is a PowerShell CLI tool in the **System-Maintenance** category of the **Windows-Scripts** enterprise toolkit. Sets HiberbootEnabled=0 under Session Manager\Power to disable hybrid hibernate boot.

**Category:** `System-Maintenance`
**Script:** `Disable-FastStartup.ps1`
**Path:** `System-Maintenance\Disable-FastStartup\Disable-FastStartup.ps1`
...
```powershell
Get-Help .\Disable-FastStartup.ps1 -Full
Get-Help .\Disable-FastStartup.ps1 -Examples
```

### Dry Run

```powershell
.\Disable-FastStartup.ps1 -WhatIf
```
...
|-----------|------|----------|---------|-------------|
| — | — | — | — | Run `Get-Help .\Disable-FastStartup.ps1 -Full` for parameter documentation |
