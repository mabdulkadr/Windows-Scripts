...
# 📂 System-Maintenance
**System Maintenance — repair, cleanup, optimization & services — 19 tools**
...
**System-Maintenance** contains **19 PowerShell CLI tools** for system maintenance — repair, cleanup, optimization & services.
...
* **16 Isolated Tools** — each in `System-Maintenance/ScriptName/` with `README.md`
