...
**Repair-TimeService** is a PowerShell CLI tool in the **System-Maintenance** category of the **Windows-Scripts** enterprise toolkit. Unregisters and re-registers the W32Time service and triggers an immediate resync.

**Category:** `System-Maintenance`
**Script:** `Repair-TimeService.ps1`
**Path:** `System-Maintenance\Repair-TimeService\Repair-TimeService.ps1`
...
```powershell
Get-Help .\Repair-TimeService.ps1 -Full
Get-Help .\Repair-TimeService.ps1 -Examples
```

### Dry Run

```powershell
.\Repair-TimeService.ps1 -WhatIf
```
...
|-----------|------|----------|---------|-------------|
| — | — | — | — | Run `Get-Help .\Repair-TimeService.ps1 -Full` for parameter documentation |
