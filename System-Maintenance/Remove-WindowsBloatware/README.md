...
**Remove-WindowsBloatware** is a PowerShell CLI tool in the **System-Maintenance** category of the **Windows-Scripts** enterprise toolkit. Uninstalls a curated list of pre-installed UWP apps for the current user.

**Category:** `System-Maintenance`
**Script:** `Remove-WindowsBloatware.ps1`
**Path:** `System-Maintenance\Remove-WindowsBloatware\Remove-WindowsBloatware.ps1`
...
```powershell
Get-Help .\Remove-WindowsBloatware.ps1 -Full
Get-Help .\Remove-WindowsBloatware.ps1 -Examples
```
...
|-----------|------|----------|---------|-------------|
| — | — | — | — | Run `Get-Help .\Remove-WindowsBloatware.ps1 -Full` for parameter documentation |
