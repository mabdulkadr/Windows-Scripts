...
**Clear-PrintQueue** is a PowerShell CLI tool in the **System-Maintenance** category of the **Windows-Scripts** enterprise toolkit. Stops the Spooler, removes all jobs in the queue, and restarts the service.

**Category:** `System-Maintenance`
**Script:** `Clear-PrintQueue.ps1`
**Path:** `System-Maintenance\Clear-PrintQueue\Clear-PrintQueue.ps1`
...
```powershell
Get-Help .\Clear-PrintQueue.ps1 -Full
Get-Help .\Clear-PrintQueue.ps1 -Examples
```
...
|-----------|------|----------|---------|-------------|
| — | — | — | — | Run `Get-Help .\Clear-PrintQueue.ps1 -Full` for parameter documentation |
