...
**Get-USBDeviceHistory** is a PowerShell CLI tool in the **System-Maintenance** category of the **Windows-Scripts** enterprise toolkit. Enumerates USB devices from registry (USBSTOR) and PnP (Get-PnpDevice), reports friendly name, last connected, and serial.

**Category:** `System-Maintenance`
**Script:** `Get-USBDeviceHistory.ps1`
**Path:** `System-Maintenance\Get-USBDeviceHistory\Get-USBDeviceHistory.ps1`
...
```powershell
Get-Help .\Get-USBDeviceHistory.ps1 -Full
Get-Help .\Get-USBDeviceHistory.ps1 -Examples
```

### Dry Run

```powershell
.\Get-USBDeviceHistory.ps1 -WhatIf
```
...
|-----------|------|----------|---------|-------------|
| — | — | — | — | Run `Get-Help .\Get-USBDeviceHistory.ps1 -Full` for parameter documentation |
