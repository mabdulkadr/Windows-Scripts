...
**Restart-Explorer** is a PowerShell CLI tool in the **System-Maintenance** category of the **Windows-Scripts** enterprise toolkit. Kills the explorer process and starts a fresh instance.

**Category:** `System-Maintenance`
**Script:** `Restart-Explorer.ps1`
**Path:** `System-Maintenance\Restart-Explorer\Restart-Explorer.ps1`
...
```powershell
Get-Help .\Restart-Explorer.ps1 -Full
Get-Help .\Restart-Explorer.ps1 -Examples
```

### Dry Run

```powershell
.\Restart-Explorer.ps1 -WhatIf
```
...
|-----------|------|----------|---------|-------------|
| — | — | — | — | Run `Get-Help .\Restart-Explorer.ps1 -Full` for parameter documentation |
