...
**Repair-WindowsImage** is a PowerShell CLI tool in the **System-Maintenance** category of the **Windows-Scripts** enterprise toolkit. Runs DISM /Online /Cleanup-Image /RestoreHealth followed by sfc /scannow to repair the component store.

**Category:** `System-Maintenance`
**Script:** `Repair-WindowsImage.ps1`
**Path:** `System-Maintenance\Repair-WindowsImage\Repair-WindowsImage.ps1`
...
```powershell
Get-Help .\Repair-WindowsImage.ps1 -Full
Get-Help .\Repair-WindowsImage.ps1 -Examples
```
...
|-----------|------|----------|---------|-------------|
| — | — | — | — | Run `Get-Help .\Repair-WindowsImage.ps1 -Full` for parameter documentation |
