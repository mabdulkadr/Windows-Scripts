...
**Reset-NetworkStack** is a PowerShell CLI tool in the **System-Maintenance** category of the **Windows-Scripts** enterprise toolkit. Runs netsh winsock reset and netsh int ip reset to recover from network stack corruption.

**Category:** `System-Maintenance`
**Script:** `Reset-NetworkStack.ps1`
**Path:** `System-Maintenance\Reset-NetworkStack\Reset-NetworkStack.ps1`
...
```powershell
Get-Help .\Reset-NetworkStack.ps1 -Full
Get-Help .\Reset-NetworkStack.ps1 -Examples
```

### Dry Run

```powershell
.\Reset-NetworkStack.ps1 -WhatIf
```
...
|-----------|------|----------|---------|-------------|
| — | — | — | — | Run `Get-Help .\Reset-NetworkStack.ps1 -Full` for parameter documentation |
