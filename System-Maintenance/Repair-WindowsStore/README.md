...
**Repair-WindowsStore** is a PowerShell CLI tool in the **System-Maintenance** category of the **Windows-Scripts** enterprise toolkit. Runs wsreset.exe -i to reset the Microsoft Store cache.

**Category:** `System-Maintenance`
**Script:** `Repair-WindowsStore.ps1`
**Path:** `System-Maintenance\Repair-WindowsStore\Repair-WindowsStore.ps1`
...
```powershell
Get-Help .\Repair-WindowsStore.ps1 -Full
Get-Help .\Repair-WindowsStore.ps1 -Examples
```

### Dry Run

```powershell
.\Repair-WindowsStore.ps1 -WhatIf
```
...
|-----------|------|----------|---------|-------------|
| — | — | — | — | Run `Get-Help .\Repair-WindowsStore.ps1 -Full` for parameter documentation |
