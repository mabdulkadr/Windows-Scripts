...
**Enable-SystemRestore** is a PowerShell CLI tool in the **System-Maintenance** category of the **Windows-Scripts** enterprise toolkit. Enables System Restore on the C: drive via Enable-ComputerRestore.

**Category:** `System-Maintenance`
**Script:** `Enable-SystemRestore.ps1`
**Path:** `System-Maintenance\Enable-SystemRestore\Enable-SystemRestore.ps1`
...
```powershell
Get-Help .\Enable-SystemRestore.ps1 -Full
Get-Help .\Enable-SystemRestore.ps1 -Examples
```

### Dry Run

```powershell
.\Enable-SystemRestore.ps1 -WhatIf
```
...
|-----------|------|----------|---------|-------------|
| — | — | — | — | Run `Get-Help .\Enable-SystemRestore.ps1 -Full` for parameter documentation |
