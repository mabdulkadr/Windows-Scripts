...
**Reset-PrintSpooler** is a PowerShell CLI tool in the **System-Maintenance** category of the **Windows-Scripts** enterprise toolkit. Stops the Spooler, clears spool files, and restarts the service.

**Category:** `System-Maintenance`
**Script:** `Reset-PrintSpooler.ps1`
**Path:** `System-Maintenance\Reset-PrintSpooler\Reset-PrintSpooler.ps1`
...
```powershell
Get-Help .\Reset-PrintSpooler.ps1 -Full
Get-Help .\Reset-PrintSpooler.ps1 -Examples
```
...
|-----------|------|----------|---------|-------------|
| — | — | — | — | Run `Get-Help .\Reset-PrintSpooler.ps1 -Full` for parameter documentation |
