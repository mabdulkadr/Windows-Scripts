...
**Invoke-SystemCleanup** is a PowerShell CLI tool in the **System-Maintenance** category of the **Windows-Scripts** enterprise toolkit. Launches cleanmgr with all categories selected for the system drive.

**Category:** `System-Maintenance`
**Script:** `Invoke-SystemCleanup.ps1`
**Path:** `System-Maintenance\Invoke-SystemCleanup\Invoke-SystemCleanup.ps1`
...
```powershell
Get-Help .\Invoke-SystemCleanup.ps1 -Full
Get-Help .\Invoke-SystemCleanup.ps1 -Examples
```
...
|-----------|------|----------|---------|-------------|
| — | — | — | — | Run `Get-Help .\Invoke-SystemCleanup.ps1 -Full` for parameter documentation |
