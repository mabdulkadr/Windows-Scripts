...
**Invoke-PCMaintenance** is a PowerShell CLI tool in the **System-Maintenance** category of the **Windows-Scripts** enterprise toolkit. Runs sfc /scannow, clears temp, and restarts Windows Update services.

**Category:** `System-Maintenance`
**Script:** `Invoke-PCMaintenance.ps1`
**Path:** `System-Maintenance\Invoke-PCMaintenance\Invoke-PCMaintenance.ps1`
...
```powershell
Get-Help .\Invoke-PCMaintenance.ps1 -Full
Get-Help .\Invoke-PCMaintenance.ps1 -Examples
```

### Dry Run

```powershell
.\Invoke-PCMaintenance.ps1 -WhatIf
```
...
|-----------|------|----------|---------|-------------|
| — | — | — | — | Run `Get-Help .\Invoke-PCMaintenance.ps1 -Full` for parameter documentation |
