...
try {
    ...
    # Tailored display: maintenance tasks
    try {
        $tasks = @('Optimize Start Menu Cache','SilentCleanup')
        Write-Host "" -ForegroundColor Gray
        Write-Host "  -- PC Maintenance Sequence --" -ForegroundColor DarkGray
        Write-Host "  Steps: DiskCleanup + Temp clear + SFC quick check" -ForegroundColor Cyan
    } catch {
