...
**Optimize-WindowsSettings** is a PowerShell CLI tool in the **System-Maintenance** category of the **Windows-Scripts** enterprise toolkit. Applies a curated set of telemetry, debloat, and performance registry tweaks.

**Category:** `System-Maintenance`
**Script:** `Optimize-WindowsSettings.ps1`
**Path:** `System-Maintenance\Optimize-WindowsSettings\Optimize-WindowsSettings.ps1`
...
```powershell
Get-Help .\Optimize-WindowsSettings.ps1 -Full
Get-Help .\Optimize-WindowsSettings.ps1 -Examples
```

### Dry Run

```powershell
.\Optimize-WindowsSettings.ps1 -WhatIf
```
...
|-----------|------|----------|---------|-------------|
| — | — | — | — | Run `Get-Help .\Optimize-WindowsSettings.ps1 -Full` for parameter documentation |
