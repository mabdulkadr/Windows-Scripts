...
**Repair-WindowsUpdate** is a PowerShell CLI tool in the **System-Maintenance** category of the **Windows-Scripts** enterprise toolkit. Stops wuauserv/bits/msiserver, clears SoftwareDistribution, and restarts the services.

**Category:** `System-Maintenance`
**Script:** `Repair-WindowsUpdate.ps1`
**Path:** `System-Maintenance\Repair-WindowsUpdate\Repair-WindowsUpdate.ps1`
...
```powershell
Get-Help .\Repair-WindowsUpdate.ps1 -Full
Get-Help .\Repair-WindowsUpdate.ps1 -Examples
```
...
|-----------|------|----------|---------|-------------|
| — | — | — | — | Run `Get-Help .\Repair-WindowsUpdate.ps1 -Full` for parameter documentation |
