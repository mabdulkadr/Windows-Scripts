...
**Watch-DiskSpace** is a PowerShell CLI tool in the **System-Maintenance** category of the **Windows-Scripts** enterprise toolkit. Reports all logical disks with Free/Total GB, % free, and color-coded health (Green >20%, Yellow 10-20%, Red <10%).

**Category:** `System-Maintenance`
**Script:** `Watch-DiskSpace.ps1`
**Path:** `System-Maintenance\Watch-DiskSpace\Watch-DiskSpace.ps1`
...
```powershell
Get-Help .\Watch-DiskSpace.ps1 -Full
Get-Help .\Watch-DiskSpace.ps1 -Examples
```

### Dry Run

```powershell
.\Watch-DiskSpace.ps1 -WhatIf
```
...
|-----------|------|----------|---------|-------------|
| — | — | — | — | Run `Get-Help .\Watch-DiskSpace.ps1 -Full` for parameter documentation |
