...
**Enable-FastStartup** is a PowerShell CLI tool in the **System-Maintenance** category of the **Windows-Scripts** enterprise toolkit. Sets HiberbootEnabled=1 under Session Manager\Power to enable hybrid hibernate boot.

**Category:** `System-Maintenance`
**Script:** `Enable-FastStartup.ps1`
**Path:** `System-Maintenance\Enable-FastStartup\Enable-FastStartup.ps1`
...
```powershell
Get-Help .\Enable-FastStartup.ps1 -Full
Get-Help .\Enable-FastStartup.ps1 -Examples
```

### Dry Run

```powershell
.\Enable-FastStartup.ps1 -WhatIf
```
...
|-----------|------|----------|---------|-------------|
| — | — | — | — | Run `Get-Help .\Enable-FastStartup.ps1 -Full` for parameter documentation |
