...
**Clear-TempCache** is a PowerShell CLI tool in the **System-Maintenance** category of the **Windows-Scripts** enterprise toolkit. Removes %TEMP%, C:\Windows\Temp, prefetch contents, and empties the Recycle Bin.

**Category:** `System-Maintenance`
**Script:** `Clear-TempCache.ps1`
**Path:** `System-Maintenance\Clear-TempCache\Clear-TempCache.ps1`
...
```powershell
Get-Help .\Clear-TempCache.ps1 -Full
Get-Help .\Clear-TempCache.ps1 -Examples
```

### Dry Run

```powershell
.\Clear-TempCache.ps1 -WhatIf
```
...
|-----------|------|----------|---------|-------------|
| — | — | — | — | Run `Get-Help .\Clear-TempCache.ps1 -Full` for parameter documentation |
