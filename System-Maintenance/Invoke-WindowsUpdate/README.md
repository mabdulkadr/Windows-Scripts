...
**Invoke-WindowsUpdate** is a PowerShell CLI tool in the **System-Maintenance** category of the **Windows-Scripts** enterprise toolkit. Uses Microsoft.Update.Session COM to search for pending updates (IsInstalled=0). Reports count and titles. With -WhatIf previews only.

**Category:** `System-Maintenance`
**Script:** `Invoke-WindowsUpdate.ps1`
**Path:** `System-Maintenance\Invoke-WindowsUpdate\Invoke-WindowsUpdate.ps1`
...
```powershell
Get-Help .\Invoke-WindowsUpdate.ps1 -Full
Get-Help .\Invoke-WindowsUpdate.ps1 -Examples
```

### Dry Run

```powershell
.\Invoke-WindowsUpdate.ps1 -WhatIf
```
...
|-----------|------|----------|---------|-------------|
| — | — | — | — | Run `Get-Help .\Invoke-WindowsUpdate.ps1 -Full` for parameter documentation |
...
* **Permissions:** Administrator for install; Standard user for scan
